...
//in this module i can't explain much cause most of the things are comming from there docs 
//But that's the thing by reading the docs we should be capable enough to integrate it into our project 
